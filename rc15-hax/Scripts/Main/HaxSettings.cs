...
public static class HaxSettings {
    ...
    public static Dictionary<string, Params> Params { get; } = new Dictionary<string, Params> {
        ...
        {"EnableProjectileMod",                 SetParams("True")},
        ...
        {"secondFireDelay",                     SetParams("0.2")},
        {"secondFireDeviation",                 SetParams("0")},
        {"PlasmaProjectileSpeed",               SetParams("500")},
        ...
        {"railReloadDuration0",                 SetParams("0.2")},
        {"railReloadDuration1",                 SetParams("0.2")},
        {"railReloadDuration2",                 SetParams("0.2")},
        {"railReloadDuration3",                 SetParams("0.2")},
        {"railFirePeriod1",                     SetParams("0")},
        {"railFirePeriod2",                     SetParams("0")},
        {"railFirePeriod3",                     SetParams("0")},
        {"railFirePeriod4",                     SetParams("0")},
        {"railFirePeriod5",                     SetParams("0")},
        {"railFireDelay",                       SetParams("0")},
        // Wheel parameters
