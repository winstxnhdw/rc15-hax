...
public static class HaxSettings {
    ...
    public static Dictionary<string, Params> Params { get; } = new Dictionary<string, Params> {
        ...
        {"plasmaFirePeriod0",                   SetParams("0.01")},
        {"plasmaFirePeriod1",                   SetParams("0.01")},
        {"plasmaFirePeriod2",                   SetParams("0.01")},
        {"plasmaFirePeriod3",                   SetParams("0.01")},
        {"plasmaFirePeriod4",                   SetParams("0.01")},
        {"plasmaFirePeriod5",                   SetParams("0.01")},
